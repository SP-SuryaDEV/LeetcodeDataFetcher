...
def codeForces(username):
    ...
    return ({'found' : found , 'current_rating' : current_rating  ,'current_rank' : current_rank ,'max_rating' : max_rating ,'max_rank' :max_rank ,'problems_count':problems_count ,'contestAttended' : contestAttended},True)